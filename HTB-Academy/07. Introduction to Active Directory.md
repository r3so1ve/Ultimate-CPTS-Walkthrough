...
| `Hyper-V Administrators`             | Members have complete an2d unrestricted access to all the features in Hyper-V. If there are virtual DCs in the domain, any virtualization admins, such as members of Hyper-V Administrators, should be considered Domain Admins.                                                                                                                                                  |
...
First we connect to target via xfreerdp
```c
xfreerdp /v:10.129.168.46 /u:htb-student_adm /p:Academy_student_DA!
```
