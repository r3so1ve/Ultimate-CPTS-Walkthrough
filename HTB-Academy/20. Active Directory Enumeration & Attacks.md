...
So I was wrong for thinking that we need to have the username lists in windows host as well. So we basically used auto-generated list from the DomainPasswordSpray tool and managed to find the correct username is seconds. So that was easier than I thou