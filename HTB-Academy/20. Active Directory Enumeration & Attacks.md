...
So this is kind of a tricky one. First we need to run the following command, which will search for Users With Specific Attributes Set (ADS_UF_ACCOUNTDISABLE)
```c
