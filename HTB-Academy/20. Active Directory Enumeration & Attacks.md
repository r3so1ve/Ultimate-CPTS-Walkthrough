...
As stated in the first passage of the module Credential Enumeration from Linux, we need to use the following credentials in our practice tasks ``
...
SMB         172.16.5.5      445    ACADEMY-EA-DC01  Help Desk Level 1                        membercount: 27
