...
We can copy and paste this line to our attack machine and name it hash.txt. Then we need to use password.list and custom.rule files from resources in the top right section in htb-academy password attacks module