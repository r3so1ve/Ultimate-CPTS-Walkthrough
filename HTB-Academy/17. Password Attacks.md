...
We got the ntlm hash again `7247e8d4387e76996ff3f18a34316fdd` which we can crack via crackstation and eventually get the `Password4` as a password for svc_workstations user. The remaining steps are to ssh as svc with its password and read the content of the file flag.txt in the home director
